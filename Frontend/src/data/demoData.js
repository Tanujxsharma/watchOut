...
export const demoTenders = [
  {
    ...
    issuer: 'Government Infrastructure Department',
    budget: '₹2,50,00,000',
    deadline: '2025-12-15',
    status: 'Open',
    ...
    requirements: 'Minimum 10 years of experience in highway construction, valid construction license, financial capability of ₹2.5 crores, environmental clearance certificate, and safety compliance certification.',
    complaints: 3,
  ...
  },
  {
    ...
    issuer: 'Municipal Water Authority',
    budget: '₹1,80,00,000',
    deadline: '2025-11-30',
    status: 'Open',
    ...
    requirements: 'Experience in water infrastructure projects, ISO certification, valid contractor license, technical expertise in smart meter installation, and ability to work with existing infrastructure.',
    complaints: 1,
    category: 'Utilities',
  ...
  },
  {
    ...
    requirements: 'Minimum 5 years experience in educational infrastructure, green building certification preferred, valid construction license, and compliance with educational building codes.',
    complaints: 0,
    category: 'Education',
    location: 'District 5',
  ...
  },
  {
    ...
    requirements: 'Specialized experience in bridge maintenance, structural engineering expertise, traffic management capability, and ability to work with minimal disruption to traffic flow.',
    complaints: 2,
    category: 'Infrastructure',
  ...
  },
  {
    ...
    issuer: 'City Municipal Corporation',
    budget: '₹50,00,000',
    deadline: '2025-12-10',
    status: 'Open',
    ...
    requirements: 'Experience in electrical infrastructure, LED lighting expertise, smart control systems knowledge, valid electrical contractor license, and ability to coordinate with multiple city departments.',
    complaints: 0,
    category: 'Utilities',
    location: 'Citywide',
  ...
  },
  {
    ...
    requirements: 'Authorized dealer/distributor of medical equipment, FDA/regulatory approvals, technical support capability, training services, warranty and maintenance contracts, and experience in healthcare equipment supply.',
    complaints: 1,
    category: 'Healthcare',
